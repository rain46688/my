...
<body>
	<section>
		...
		<script>
			...
			const conn = new WebSocket('wss://192.168.219.101:8443/socketrtc');

			conn.onopen = function() {
				printdiv("signaling server 연결");
				printdiv("닉네임 : ${loginnedMember.nickname}, 방번호 : ${loginnedMember.curRoomBid}, 방장 여부 : ${loginnedMember.host}");
